...
namespace Codingame.Demo
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //CPU Bound
            CPUBoundAsynchronous cpu = new CPUBoundAsynchronous();

            var totalAfterTax = cpu.CalculateTotalAfterTaxAsync(70);
            cpu.DoSomethingSynchronous();
        ...
        static async Task GetStringAsync()
        {
            ...
            string result = await httpClient.GetStringAsync("http://www.dir.bg"); //execution pauses here while awaiting GetStringAsync to complete
